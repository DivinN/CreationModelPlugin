...
{
    public static class RoofHelper
    {
        internal static ExtrusionRoof CreateRoof(Document doc, string level2Name, Wall wall0, Wall wall1, double heightInMm)
        {
            ...
            XYZ vect = pointEnd - pointStart; // вектор направленности 
            double wall0HalfWidth = wall0.Width / 2;
            XYZ vectScaled = vect * wall0HalfWidth / vect.GetLength(); // вектор направленности нужной длины
            ...
            pointStart = pointStart.Add(roofOffset);
            pointMiddle = pointMiddle.Add(roofOffset);
            pointEnd = pointEnd.Add(roofOffset);


            // Создаем линии по стене
